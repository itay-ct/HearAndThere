...
export function TourLoadingCard({ tourNumber }: TourLoadingCardProps) {
  return (
    <article className="min-w-[260px] flex-1 rounded-2xl border border-slate-200 px-4 py-4 bg-white/90">
      <div className="flex items-center justify-center h-full min-h-[300px]">
        <div className="text-center">
          <div className="relative inline-block">
            {/* Pulsing background circle */}
            <div className="absolute inset-0 rounded-full bg-sky-200 animate-pulse opacity-30"></div>
